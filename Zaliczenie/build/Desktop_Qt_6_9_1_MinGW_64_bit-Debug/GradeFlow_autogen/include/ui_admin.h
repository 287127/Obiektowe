...
"color: rgb(255,255,255);"));
        ...
        UsrMenu = new QFrame(AdminWindow);
        UsrMenu->setObjectName("UsrMenu");
        UsrMenu->setGeometry(QRect(150, 0, 1131, 660));
        UsrMenu->setMinimumSize(QSize(0, 660));
        UsrMenu->setMaximumSize(QSize(16777215, 660));
        UsrMenu->setFrameShape(QFrame::Shape::StyledPanel);
        UsrMenu->setFrameShadow(QFrame::Shadow::Raised);
        UsrList = new QTableView(UsrMenu);
...
"}"));
        horizontalLayoutWidget = new QWidget(UsrMenu);
        ...
        horizontalLayout->addWidget(AdminAddUsrBtn);

        AdminDelUsrBtn = new QPushButton(horizontalLayoutWidget);
        AdminDelUsrBtn->setObjectName("AdminDelUsrBtn");

        horizontalLayout->addWidget(AdminDelUsrBtn);

        AdminEditUsrBtn = new QPushButton(horizontalLayoutWidget);
        AdminEditUsrBtn->setObjectName("AdminEditUsrBtn");

        horizontalLayout->addWidget(AdminEditUsrBtn);

        SideBar = new QFrame(AdminWindow);
        SideBar->setObjectName("SideBar");
        SideBar->setGeometry(QRect(0, -1, 151, 720));
        SideBar->setMaximumSize(QSize(16777215, 720));
        SideBar->setStyleSheet(QString::fromUtf8("background-color: rgb(33, 33, 33);"));
        ...
        VerticalLayout->addWidget(AdminUsrBtn);
        ...
        VerticalLayout->addWidget(AdminClassBtn);
        ...
        VerticalLayout->addWidget(AdminSubjBtn);
        ...
        VerticalLayout->addWidget(AdminSchdBtn);
        ...
        VerticalLayout->addWidget(AdminLogoutBtn);

        SubjMenu = new QFrame(AdminWindow);
        SubjMenu->setObjectName("SubjMenu");
        SubjMenu->setGeometry(QRect(150, 0, 1130, 660));
        SubjMenu->setMinimumSize(QSize(1130, 660));
        SubjMenu->setMaximumSize(QSize(1280, 1130));
        SubjMenu->setFrameShape(QFrame::Shape::StyledPanel);
        SubjMenu->setFrameShadow(QFrame::Shadow::Raised);
        horizontalLayoutWidget_2 = new QWidget(SubjMenu);
...
"        border: 1px solid #222222;\n"
"}"));
        SchdMenu = new QFrame(AdminWindow);
        SchdMenu->setObjectName("SchdMenu");
        SchdMenu->setGeometry(QRect(150, 0, 1130, 660));
        SchdMenu->setFrameShape(QFrame::Shape::StyledPanel);
        SchdMenu->setFrameShadow(QFrame::Shadow::Raised);
        horizontalLayoutWidget_3 = new QWidget(SchdMenu);
...
"        border: 1px solid #222222;\n"
"}"));
        ClassMenu = new QFrame(AdminWindow);
        ClassMenu->setObjectName("ClassMenu");
        ClassMenu->setGeometry(QRect(150, 0, 1130, 660));
        ClassMenu->setFrameShape(QFrame::Shape::StyledPanel);
        ClassMenu->setFrameShadow(QFrame::Shadow::Raised);
        horizontalLayoutWidget_4 = new QWidget(ClassMenu);
